const jennovaData = {
  ...
  stats: {
    HP: { value: 122, min: 354, max: 385 },
    Attack: { value: 67, min: 125, max: 256 },
    Defense: { value: 122, min: 224, max: 377 },
    "Sp. Atk": { value: 145, min: 265, max: 427 },
    "Sp. Def": { value: 122, min: 224, max: 377 },
    Speed: { value: 102, min: 188, max: 333 },
  },
  entries: [
    {
      version: "Scarlet",
